...
def generate_cvrptw_data(dataset_size, instance_size):
    ...
    arr_time = []
    flight_per_hr = np.random.randint(5, 25, size=(dataset_size, 23)).tolist()
    # print(flight_per_hr)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_size', type=int, default=20, help="How many datasets you want to generate")
    parser.add_argument('--instance_sizes', type=int, nargs='+', default=[20],
                        help="Sizes of problem instances (default 20, 50, 100)")
    parser.add_argument('--seed', type=int, default=2020, help="Random seed")  # 2020 for train, 2021 for test
