...
def get_options(args=None):
    parser = argparse.ArgumentParser(
        description="Attention based model for solving the Airport Ground Handling Problem with Reinforcement Learning")
    ...
    parser.add_argument('--optimizer', default='Adam', help="Optimizer type, 'Adam' (default) or 'RMSprop' or 'SGD'")
